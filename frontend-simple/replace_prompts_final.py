#!/usr/bin/env python3
"""Replace the four prompt() calls in fusion module with modal versions"""

with open('/home/admin/.openclaw/workspace/crm-system/frontend-simple/index.html', 'r') as f:
    content = f.read()

# 1. Replace openFollowEdit
...
if old1 in content:
    ...
    print("Replaced openFollowEdit")
else:
    print("WARNING: openFollowEdit pattern not found exactly")

# 2. Replace openFollowAdd
old2 = '''        // 打开添加跟进记录弹窗
...
if old2 in content:
    ...
    print("Replaced openFollowAdd")
else:
    print("WARNING: openFollowAdd pattern not found exactly")

# 3. Replace addCompanyForGroup
old3 = '''        // 为客户经理解锁添加企业
...
if old3 in content:
    ...
    print("Replaced addCompanyForGroup")
else:
    print("WARNING: addCompanyForGroup pattern not found exactly")

# 4. Replace editGroupField
...
if old4 in content:
    ...
    print("Replaced editGroupField")
else:
    print("WARNING: editGroupField pattern not found exactly")

with open('/home/admin/.openclaw/workspace/crm-system/frontend-simple/index.html', 'w') as f:
    f.write(content)

print(f"\nDone! File size: {len(content)} bytes")
print("Checking for remaining prompt() calls in fusion module...")
if 'prompt' in content[4780:5000]:
    print("WARNING: prompt() still found in fusion functions!")
else:
    print("All prompt() calls replaced successfully!")